...
1. Install the plugin from within the Dashboard or upload the directory `scheduled-jobs-dashboard-widget` and all its contents to the `/wp-content/plugins/` directory
